                ...
                <VStack align="stretch" spacing={8}>
                    ...
                    <Flex justify="space-between" align="flex-start" w="full" pb={4} borderBottom="2px solid">
                        <VStack align="flex-start" spacing={1}>
                            <Heading size="xl" fontWeight="bold">Welcome Back, Registrar</Heading>
                            <Text color="gray.500" fontSize="md">Overview of Registrar</Text>
                            <Badge variant="subtle" color="purple.600" size="md">
                                S.Y {academicYear.StartYear}- {academicYear.EndYear}
                            </Badge>
                        </VStack>

                        <VStack align="flex-end" spacing={0} mt={5}>
                            <Heading size="xl" fontWeight="semibold" color="gray.800">{greeting}, {userName}</Heading>
                            <Text fontSize="sm" color="gray.500">
                                Registrar | Today {formatTime(currentTime)}
                            </Text>
                        </VStack>
                    </Flex>
